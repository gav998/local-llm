...
Invoke-LoggedNative $Python @('-c','import paddle,paddleocr,paddlex; print(paddle.__version__,paddleocr.__version__,paddlex.__version__)') 'OCR import smoke failed'
