...
echo   8. Devices
echo   9. Install
echo   A. Start ingestion CPU test
echo   0. Exit
echo.
"%SystemRoot%\System32\choice.exe" /C 123456789A0 /N /M "Select action: "
set "MENU_CHOICE=%ERRORLEVEL%"

if "%MENU_CHOICE%"=="11" exit /b 0
...
if "%MENU_CHOICE%"=="8" call :run_control devices
if "%MENU_CHOICE%"=="9" call :run_control install
if "%MENU_CHOICE%"=="10" call :run_control start ingestion-cpu
goto menu
