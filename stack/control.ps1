...
try{switch($CommandName.ToLowerInvariant()){
 ...
 'start'{Assert-Deployment;switch($Profile){'ingestion'{Start-Ingestion}'chat'{Start-Chat}default{Start-Core;Write-Host '`n[OK] core profile ready: http://127.0.0.1:9388' -ForegroundColor Green}}}
 'stop'{Stop-All}
