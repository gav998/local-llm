...
То же правило действует внутри build hooks: архивы, wheels, assets, модели и
патчируемые исходники не блокируются по hash/size; патчи используют только
локальные семантические маркеры и сохраняют посторонние изменения рабочего продукта.
